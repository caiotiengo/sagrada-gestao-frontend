    ...
    return (
      <PublicLayout>
        <div className="mx-auto max-w-lg px-4 py-16 text-center">
          <ShoppingCart className="mx-auto mb-4 size-12 text-primary" />
          <h1 className="text-2xl font-bold">Pedido realizado!</h1>
          {orderNumber && (
            <div className="mt-4 rounded-xl border-2 border-primary/20 bg-primary/5 p-6">
              <p className="text-sm text-muted-foreground">Número do pedido</p>
              <p className="mt-1 text-3xl font-bold tracking-wider text-primary">{orderNumber}</p>
              <p className="mt-2 text-xs text-muted-foreground">Guarde este número para retirada</p>
            </div>
          )}
          <p className="mt-4 text-muted-foreground">
            Seu pedido foi enviado com sucesso. Aguarde a confirmação da casa.
          </p>
    ...
    <PublicLayout>
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-10">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">{data.house.name}</h1>
            <p className="text-sm text-muted-foreground">
              {hasCanteen && !hasStore ? 'Cantina' : hasStore && !hasCanteen ? 'Loja' : 'Loja & Cantina'}
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <div className="space-y-4 lg:col-span-3">
            {allItems.length > 0 ? (
              <>
                {/* Category toggle - only if both exist */}
                {hasBoth && (
                  <div className="flex gap-1.5 rounded-lg bg-muted p-1">
                    ...
                    >
                      ...
                      Loja
                      <Badge variant="secondary" className="ml-0.5 text-[0.625rem] px-1.5 py-0">
                        {storeItems.length}
                      </Badge>
                    </Button>
                    <Button
