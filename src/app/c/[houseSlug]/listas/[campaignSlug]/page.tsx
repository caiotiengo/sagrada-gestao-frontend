...
export default function PublicCampaignPage({ params }: PageProps) {
  ...
  if (isError || !campaign) {
    return (
      <PublicLayout>
        <ErrorState
          title="Lista n&atilde;o encontrada"
          message="N&atilde;o foi poss&iacute;vel carregar os dados da lista."
          onRetry={refetch}
        />
      </PublicLayout>
    )
    ...
    <PublicLayout>
      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-10">
          ...
          <div className="mb-6 flex items-center gap-3 rounded-lg border border-green-200 bg-green-50 px-4 py-3 dark:border-green-900 dark:bg-green-950/30">
            ...
            <div className="min-w-0 text-sm">
              ...
              <p className="text-green-800 dark:text-green-200">
                Esta lista foi encerrada. Obrigado a todos que contribuíram!
              </p>
            </div>
          </div>
        )}
          ...
          <div className="mb-6 flex items-center gap-3 rounded-lg border border-destructive/30 bg-destructive/5 px-4 py-3">
            ...
            <div className="min-w-0 text-sm">
              ...
              <p className="text-muted-foreground">
                Esta lista foi cancelada e não aceita novas contribuições.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          {/* Contribution Form or Closed State */}
            ...
            {isClosed ? (
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                          Esta lista foi concluída e não aceita novas contribuições.
                        </p>
                      </div>
                    </>
                  ) : (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Faça sua contribuição para esta lista
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form
